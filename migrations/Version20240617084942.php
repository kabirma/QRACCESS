 ...
 */
final class Version20240617084942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE import CHANGE user_id user_id INT DEFAULT NULL');
        // $this->addSql('ALTER TABLE import_header DROP INDEX IDX_124312D9B6A263D9, ADD UNIQUE INDEX UNIQ_124312D9B6A263D9 (import_id)');
        $this->addSql('ALTER TABLE import_row ADD contain_qr TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE import CHANGE user_id user_id INT NOT NULL');
        // $this->addSql('ALTER TABLE import_header DROP INDEX UNIQ_124312D9B6A263D9, ADD INDEX IDX_124312D9B6A263D9 (import_id)');
        $this->addSql('ALTER TABLE import_row DROP contain_qr');
